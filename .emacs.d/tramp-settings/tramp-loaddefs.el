...
;;;;;;  tramp-default-method-alist) "tramp" "tramp.el" (20229 46715))
...
(custom-autoload (quote tramp-default-method-alist) "tramp" t)
...
(custom-autoload (quote tramp-default-user-alist) "tramp" t)
...
(autoload (quote tramp-set-completion-function) "tramp" "\
...
(autoload (quote tramp-parse-rhosts) "tramp" "\
Return a list of (user host) tuples allowed to access.
Either user or host may be nil.

\(fn FILENAME)" nil nil)

(autoload (quote tramp-parse-shosts) "tramp" "\
Return a list of (user host) tuples allowed to access.
User is always nil.

\(fn FILENAME)" nil nil)

(autoload (quote tramp-parse-sconfig) "tramp" "\
Return a list of (user host) tuples allowed to access.
User is always nil.

\(fn FILENAME)" nil nil)

(autoload (quote tramp-parse-shostkeys) "tramp" "\
Return a list of (user host) tuples allowed to access.
User is always nil.

\(fn DIRNAME)" nil nil)

(autoload (quote tramp-parse-sknownhosts) "tramp" "\
Return a list of (user host) tuples allowed to access.
User is always nil.

\(fn DIRNAME)" nil nil)

(autoload (quote tramp-parse-hosts) "tramp" "\
Return a list of (user host) tuples allowed to access.
User is always nil.

\(fn FILENAME)" nil nil)

(autoload (quote tramp-parse-passwd) "tramp" "\
Return a list of (user host) tuples allowed to access.
Host is always \"localhost\".

\(fn FILENAME)" nil nil)

(autoload (quote tramp-parse-netrc) "tramp" "\
Return a list of (user host) tuples allowed to access.
User may be nil.

\(fn FILENAME)" nil nil)

(autoload (quote tramp-parse-putty) "tramp" "\
Return a list of (user host) tuples allowed to access.
User is always nil.

\(fn REGISTRY)" nil nil)

(autoload (quote tramp-make-tramp-temp-file) "tramp" "\
Create a temporary file on the remote host identified by VEC.
Return the local name of the temporary file.

\(fn VEC)" nil nil)

(autoload (quote tramp-read-passwd) "tramp" "\
...
(autoload (quote tramp-clear-passwd) "tramp" "\
Clear password cache for connection related to VEC.

\(fn VEC)" nil nil)

(autoload (quote tramp-time-less-p) "tramp" "\
Say whether time value T1 is less than time value T2.

\(fn T1 T2)" nil nil)

(autoload (quote tramp-time-diff) "tramp" "\
...
;;;;;;  "tramp-cache" "tramp-cache.el" (20229 45783))
...
;;;;;;  tramp-cleanup-connection) "tramp-cmds" "tramp-cmds.el" (20229
;;;;;;  45839))
...
(autoload (quote tramp-cleanup-this-connection) "tramp-cmds" "\
...
(when (featurep (quote xemacs)) (add-to-list (quote tramp-methods) (cons tramp-efs-method nil)) (add-to-list (quote tramp-default-method-alist) (list "\\`ftp\\." nil tramp-efs-method)) (add-to-list (quote tramp-default-method-alist) (list nil "\\`\\(anonymous\\|ftp\\)\\'" tramp-efs-method)) (when (listp package-get-download-sites) (mapcar (lambda (x) (when (listp x) (add-to-list (quote tramp-default-method-alist) (list (concat "\\`" (nth 1 x) "\\'") "\\`anonymous\\'" tramp-efs-method)))) package-get-download-sites)))

(eval-after-load (quote tramp) (quote (tramp-set-completion-function tramp-efs-method (quote ((tramp-parse-netrc "~/.netrc"))))))
...
(unless (featurep (quote xemacs)) (add-to-list (quote tramp-methods) (cons tramp-ftp-method nil)) (add-to-list (quote tramp-default-method-alist) (list "\\`ftp\\." nil tramp-ftp-method)) (add-to-list (quote tramp-default-method-alist) (list nil "\\`\\(anonymous\\|ftp\\)\\'" tramp-ftp-method)))

(eval-after-load (quote tramp) (quote (tramp-set-completion-function tramp-ftp-method (quote ((tramp-parse-netrc "~/.netrc"))))))
...
;;;;;;  "tramp-gvfs" "tramp-gvfs.el" (20229 46094))
...
(add-to-list (quote tramp-default-user-alist) (quote ("\\`synce\\'" nil nil)))
...
(add-to-list (quote tramp-default-user-alist) (list (concat "\\`" (regexp-opt (list tramp-gw-tunnel-method tramp-gw-socks-method)) "\\'") nil (user-login-name)))
...
;;;;;;  "tramp-sh" "tramp-sh.el" (20240 20595))
...
(add-to-list (quote tramp-methods) (quote ("rcp" (tramp-login-program "rsh") (tramp-login-args (("%h") ("-l" "%u"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-copy-program "rcp") (tramp-copy-args (("-p" "%k") ("-r"))) (tramp-copy-keep-date t) (tramp-copy-recursive t))))

(add-to-list (quote tramp-methods) (quote ("remcp" (tramp-login-program "remsh") (tramp-login-args (("%h") ("-l" "%u"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-copy-program "rcp") (tramp-copy-args (("-p" "%k"))) (tramp-copy-keep-date t))))
...
(add-to-list (quote tramp-methods) (quote ("sftp" (tramp-login-program "ssh") (tramp-login-args (("-l" "%u") ("-p" "%p") ("-e" "none") ("%h"))) (tramp-async-args (("-q"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-copy-program "sftp"))))

(add-to-list (quote tramp-methods) (quote ("rsync" (tramp-login-program "ssh") (tramp-login-args (("-l" "%u") ("-p" "%p") ("-e" "none") ("%h"))) (tramp-async-args (("-q"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-copy-program "rsync") (tramp-copy-args (("-e" "ssh") ("-t" "%k") ("-r"))) (tramp-copy-keep-date t) (tramp-copy-keep-tmpfile t) (tramp-copy-recursive t))))
...
(add-to-list (quote tramp-methods) (quote ("rsh" (tramp-login-program "rsh") (tramp-login-args (("%h") ("-l" "%u"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")))))

(add-to-list (quote tramp-methods) (quote ("remsh" (tramp-login-program "remsh") (tramp-login-args (("%h") ("-l" "%u"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")))))

(add-to-list (quote tramp-methods) (quote ("ssh" (tramp-login-program "ssh") (tramp-login-args (("-l" "%u") ("-p" "%p") ("-e" "none") ("%h"))) (tramp-async-args (("-q"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-gw-args (("-o" "GlobalKnownHostsFile=/dev/null") ("-o" "UserKnownHostsFile=/dev/null") ("-o" "StrictHostKeyChecking=no"))) (tramp-default-port 22))))

(add-to-list (quote tramp-methods) (quote ("ssh1" (tramp-login-program "ssh") (tramp-login-args (("-l" "%u") ("-p" "%p") ("-1") ("-e" "none") ("%h"))) (tramp-async-args (("-q"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-gw-args (("-o" "GlobalKnownHostsFile=/dev/null") ("-o" "UserKnownHostsFile=/dev/null") ("-o" "StrictHostKeyChecking=no"))) (tramp-default-port 22))))

(add-to-list (quote tramp-methods) (quote ("ssh2" (tramp-login-program "ssh") (tramp-login-args (("-l" "%u") ("-p" "%p") ("-2") ("-e" "none") ("%h"))) (tramp-async-args (("-q"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-gw-args (("-o" "GlobalKnownHostsFile=/dev/null") ("-o" "UserKnownHostsFile=/dev/null") ("-o" "StrictHostKeyChecking=no"))) (tramp-default-port 22))))

(add-to-list (quote tramp-methods) (quote ("sshx" (tramp-login-program "ssh") (tramp-login-args (("-l" "%u") ("-p" "%p") ("-e" "none") ("-t" "-t") ("%h") ("/bin/sh"))) (tramp-async-args (("-q"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-gw-args (("-o" "GlobalKnownHostsFile=/dev/null") ("-o" "UserKnownHostsFile=/dev/null") ("-o" "StrictHostKeyChecking=no"))) (tramp-default-port 22))))

(add-to-list (quote tramp-methods) (quote ("telnet" (tramp-login-program "telnet") (tramp-login-args (("%h") ("%p"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-default-port 23))))

(add-to-list (quote tramp-methods) (quote ("su" (tramp-login-program "su") (tramp-login-args (("-") ("%u"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")))))

(add-to-list (quote tramp-methods) (quote ("sudo" (tramp-login-program "sudo") (tramp-login-args (("-u" "%u") ("-s") ("-H") ("-p" "Password:"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")))))

(add-to-list (quote tramp-methods) (quote ("ksu" (tramp-login-program "ksu") (tramp-login-args (("%u") ("-q"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")))))

(add-to-list (quote tramp-methods) (quote ("krlogin" (tramp-login-program "krlogin") (tramp-login-args (("%h") ("-l" "%u") ("-x"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")))))

(add-to-list (quote tramp-methods) (quote ("plink" (tramp-login-program "plink") (tramp-login-args (("-l" "%u") ("-P" "%p") ("-ssh") ("%h"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-password-end-of-line "xy") (tramp-default-port 22))))

(add-to-list (quote tramp-methods) (quote ("plink1" (tramp-login-program "plink") (tramp-login-args (("-l" "%u") ("-P" "%p") ("-1" "-ssh") ("%h"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-password-end-of-line "xy") (tramp-default-port 22))))

(add-to-list (quote tramp-methods) (\` ("plinkx" (tramp-login-program "plink") (tramp-login-args (("-load") ("%h") ("-t") ((\, (format "env 'TERM=%s' 'PROMPT_COMMAND=' 'PS1=%s'" tramp-terminal-type tramp-initial-end-of-output))) ("/bin/sh"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")))))

(add-to-list (quote tramp-methods) (quote ("pscp" (tramp-login-program "plink") (tramp-login-args (("-l" "%u") ("-P" "%p") ("-ssh") ("%h"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-copy-program "pscp") (tramp-copy-args (("-P" "%p") ("-scp") ("-p" "%k") ("-q") ("-r"))) (tramp-copy-keep-date t) (tramp-copy-recursive t) (tramp-password-end-of-line "xy") (tramp-default-port 22))))

(add-to-list (quote tramp-methods) (quote ("psftp" (tramp-login-program "plink") (tramp-login-args (("-l" "%u") ("-P" "%p") ("-ssh") ("%h"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-c")) (tramp-copy-program "pscp") (tramp-copy-args (("-P" "%p") ("-sftp") ("-p" "%k") ("-q") ("-r"))) (tramp-copy-keep-date t) (tramp-copy-recursive t) (tramp-password-end-of-line "xy"))))

(add-to-list (quote tramp-methods) (quote ("fcp" (tramp-login-program "fsh") (tramp-login-args (("%h") ("-l" "%u") ("sh" "-i"))) (tramp-remote-shell "/bin/sh") (tramp-remote-shell-args ("-i") ("-c")) (tramp-copy-program "fcp") (tramp-copy-args (("-p" "%k"))) (tramp-copy-keep-date t))))

(add-to-list (quote tramp-default-method-alist) (\` ((\, tramp-local-host-regexp) "\\`root\\'" "su")))

(add-to-list (quote tramp-default-user-alist) (\` ((\, (concat "\\`" (regexp-opt (quote ("su" "sudo" "ksu"))) "\\'")) nil "root")))

(add-to-list (quote tramp-default-user-alist) (\` ((\, (concat "\\`" (regexp-opt (quote ("rcp" "remcp" "rsh" "telnet" "krlogin" "plink" "plink1" "pscp" "psftp" "fcp"))) "\\'")) nil (\, (user-login-name)))))

(defconst tramp-completion-function-alist-rsh (quote ((tramp-parse-rhosts "/etc/hosts.equiv") (tramp-parse-rhosts "~/.rhosts"))) "\
Default list of (FUNCTION FILE) pairs to be examined for rsh methods.")

(defconst tramp-completion-function-alist-ssh (quote ((tramp-parse-rhosts "/etc/hosts.equiv") (tramp-parse-rhosts "/etc/shosts.equiv") (tramp-parse-shosts "/etc/ssh_known_hosts") (tramp-parse-sconfig "/etc/ssh_config") (tramp-parse-shostkeys "/etc/ssh2/hostkeys") (tramp-parse-sknownhosts "/etc/ssh2/knownhosts") (tramp-parse-rhosts "~/.rhosts") (tramp-parse-rhosts "~/.shosts") (tramp-parse-shosts "~/.ssh/known_hosts") (tramp-parse-sconfig "~/.ssh/config") (tramp-parse-shostkeys "~/.ssh2/hostkeys") (tramp-parse-sknownhosts "~/.ssh2/knownhosts"))) "\
Default list of (FUNCTION FILE) pairs to be examined for ssh methods.")

(defconst tramp-completion-function-alist-telnet (quote ((tramp-parse-hosts "/etc/hosts"))) "\
Default list of (FUNCTION FILE) pairs to be examined for telnet methods.")

(defconst tramp-completion-function-alist-su (quote ((tramp-parse-passwd "/etc/passwd"))) "\
Default list of (FUNCTION FILE) pairs to be examined for su methods.")

(defconst tramp-completion-function-alist-putty (quote ((tramp-parse-putty "HKEY_CURRENT_USER\\Software\\SimonTatham\\PuTTY\\Sessions"))) "\
Default list of (FUNCTION REGISTRY) pairs to be examined for putty methods.")

(eval-after-load (quote tramp) (quote (progn (tramp-set-completion-function "rcp" tramp-completion-function-alist-rsh) (tramp-set-completion-function "remcp" tramp-completion-function-alist-rsh) (tramp-set-completion-function "scp" tramp-completion-function-alist-ssh) (tramp-set-completion-function "scp1" tramp-completion-function-alist-ssh) (tramp-set-completion-function "scp2" tramp-completion-function-alist-ssh) (tramp-set-completion-function "scpc" tramp-completion-function-alist-ssh) (tramp-set-completion-function "scpx" tramp-completion-function-alist-ssh) (tramp-set-completion-function "sftp" tramp-completion-function-alist-ssh) (tramp-set-completion-function "rsync" tramp-completion-function-alist-ssh) (tramp-set-completion-function "rsyncc" tramp-completion-function-alist-ssh) (tramp-set-completion-function "rsh" tramp-completion-function-alist-rsh) (tramp-set-completion-function "remsh" tramp-completion-function-alist-rsh) (tramp-set-completion-function "ssh" tramp-completion-function-alist-ssh) (tramp-set-completion-function "ssh1" tramp-completion-function-alist-ssh) (tramp-set-completion-function "ssh2" tramp-completion-function-alist-ssh) (tramp-set-completion-function "ssh1_old" tramp-completion-function-alist-ssh) (tramp-set-completion-function "ssh2_old" tramp-completion-function-alist-ssh) (tramp-set-completion-function "sshx" tramp-completion-function-alist-ssh) (tramp-set-completion-function "telnet" tramp-completion-function-alist-telnet) (tramp-set-completion-function "su" tramp-completion-function-alist-su) (tramp-set-completion-function "sudo" tramp-completion-function-alist-su) (tramp-set-completion-function "ksu" tramp-completion-function-alist-su) (tramp-set-completion-function "krlogin" tramp-completion-function-alist-rsh) (tramp-set-completion-function "plink" tramp-completion-function-alist-ssh) (tramp-set-completion-function "plink1" tramp-completion-function-alist-ssh) (tramp-set-completion-function "plinkx" tramp-completion-function-alist-putty) (tramp-set-completion-function "pscp" tramp-completion-function-alist-ssh) (tramp-set-completion-function "fcp" tramp-completion-function-alist-ssh))))

(defvar tramp-remote-path (quote (tramp-default-remote-path "/bin" "/usr/bin" "/usr/sbin" "/usr/local/bin" "/local/bin" "/local/freeware/bin" "/local/gnu/bin" "/usr/freeware/bin" "/usr/pkg/bin" "/usr/contrib/bin" "/opt/bin" "/opt/sbin")) "\
...
(custom-autoload (quote tramp-remote-path) "tramp-sh" t)
...
(unless (memq system-type (quote (cygwin windows-nt))) (add-to-list (quote tramp-methods) (\` ((\, tramp-smb-method) (tramp-remote-shell "") (tramp-tmpdir "/C$/Temp")))))

(add-to-list (quote tramp-default-method-alist) (\` (nil (\, tramp-prefix-domain-regexp) (\, tramp-smb-method))))

(add-to-list (quote tramp-default-user-alist) (\` ((\, (concat "\\`" tramp-smb-method "\\'")) nil nil)))

(eval-after-load (quote tramp) (quote (tramp-set-completion-function tramp-smb-method (quote ((tramp-parse-netrc "~/.netrc"))))))
...
;;;***

;;;### (autoloads nil "trampver" "trampver.el" (20304 17092))
